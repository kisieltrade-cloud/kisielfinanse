...
excerpt: >-
  ETF to najprostszy sposób, żeby inwestować w setki spółek jednocześnie - za
  ułamek kosztów tradycyjnego funduszu. Tłumaczymy czym są ETF-y, jak kupić
  pierwszą jednostkę i od czego zacząć, nawet jeśli masz tylko 100 zł
  miesięcznie.
date: '2026-05-29'
updated: '2026-06-30'
tag: Inwestycje
...
author: Mateusz
metaTitle: Czym są ETF-y i jak zacząć inwestować? Poradnik dla począ...
metaDescription: >-
  ETF to najprostszy sposób, żeby inwestować w setki spółek jednocześnie - za
  ułamek kosztów tradycyjnego funduszu. Tłumaczymy czym są ETF-y, jak kupić
  pierwszą j
keywords:
  ...
  - podatek Belki
faq:
  - q: "Co to jest ETF i jak działa?"
    a: "ETF (Exchange Traded Fund) to fundusz inwestycyjny notowany na giełdzie, który śledzi indeks - np. S&P 500 lub MSCI World. Kupując jedną jednostkę ETF inwestujesz jednocześnie w setki lub tysiące spółek. ETF-y są tanie (opłaty 0,03-0,50% rocznie), płynne i podatkowo efektywne."
  - q: "Jak kupić ETF w Polsce?"
    a: "Otwórz rachunek maklerski lub IKE/IKZE u brokera z dostępem do zagranicznych giełd (XTB, IBKR, Degiro, mBank). Szukaj ETF-ów na Euronext Amsterdam lub XETRA - tam notowane są najpopularne fundusze jak VWCE, CSPX czy EIMI. Kupujesz jak akcje - przez platformę brokera."
  - q: "Jaki ETF wybrać na początek?"
    a: "Dla początkujących najlepszy jest jeden szeroki ETF globalny: VWCE (Vanguard FTSE All-World, ok. 3700 spółek, TER 0,22%) lub IWDA (iShares MSCI World, rynki rozwinięte, TER 0,20%). Jeden ETF wystarczy do dobrej dywersyfikacji - nie potrzebujesz kilkunastu funduszy."
  - q: "Czy ETF jest bezpieczny?"
    a: "ETF-y są bezpieczniejsze niż pojedyncze akcje dzięki dywersyfikacji, ale nie są wolne od ryzyka rynkowego - ich wartość spada gdy spada rynek. Ważne: wybieraj ETF-y dużych emitentów (Vanguard, iShares, Amundi) z aktywami powyżej 500 mln EUR i długą historią. Unikaj małych, egzotycznych funduszy."
howtoTitle: "Jak kupić pierwszego ETF-a krok po kroku"
howto:
  - name: "Otwórz konto maklerskie"
    text: "Załóż rachunek maklerski lub IKE/IKZE u brokera z dostępem do ETF-ów (na przykład XTB, DM BOŚ lub mBank eMakler). Otwarcie konta trwa kilkanaście minut i odbywa się przez internet lub aplikację."
  - name: "Zasil konto"
    text: "Przelej pieniądze ze swojego konta bankowego na rachunek maklerski. U większości brokerów środki docierają w ciągu kilku godzin, w XTB natychmiast przez BLIK."
  - name: "Znajdź ETF-a"
    text: "Wpisz ticker funduszu (na przykład VWCE lub CSPX) w wyszukiwarkę platformy. Zwróć uwagę na walutę, giełdę notowania oraz typ - akumulujący (Acc) lub dystrybucyjny (Dist)."
  - name: "Złóż zlecenie kupna"
    text: "Wybierz opcję Kup i podaj liczbę jednostek. Dla pierwszego zakupu najprostsze jest zlecenie rynkowe, które realizuje się natychmiast po aktualnej cenie rynkowej."
  - name: "Trzymaj i dokupuj regularnie"
    text: "Inwestuj długoterminowo, dokupując co miesiąc tę samą kwotę (strategia DCA). Regularne wpłaty niezależnie od koniunktury wygładzają wahania rynku i budują kapitał w czasie."
---

**W skrócie: ETF to fundusz notowany na giełdzie, który jednym zakupem daje Ci udział w setkach lub tysiącach spółek naraz - np. cały świat za ok. 0,2% opłaty rocznie. Kupisz go przez konto maklerskie lub IKE/IKZE, już od kilkuset złotych. Dla początkującego najprościej: jeden szeroki ETF na rynek globalny, dokupowany regularnie co miesiąc.**
...
W Polsce zyski z inwestycji giełdowych (tzw. zyski kapitałowe) są opodatkowane stawką 19%. Nazywa się to potocznie [podatkiem Belki](/inwestycje/podatek-od-etf-dywidendy-belka).
