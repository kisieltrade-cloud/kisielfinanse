...
faq:
  - q: "Co to jest DCA i jak działa?"
    a: "DCA (Dollar Cost Averaging) to strategia regularnego inwestowania stałej kwoty w równych odstępach czasu - np. 500 zł co miesiąc w ETF. Kupujesz więcej jednostek gdy cena jest niska i mniej gdy jest wysoka, co automatycznie uśrednia cenę zakupu i eliminuje ryzyko złego timingu."
  - q: "DCA czy lump sum - co jest lepsze?"
    a: "Dane historyczne pokazują, że lump sum (zainwestowanie całości od razu) wygrywa z DCA w ok. 65-70% przypadków na rynkach rosnących. Jednak DCA jest psychologicznie łatwiejsza, eliminuje problem timingu i jest jedyną opcją gdy nie masz dużego kapitału na start. Dla większości inwestorów regularne inwestowanie co miesiąc to najlepsza strategia."
  - q: "Jak często stosować DCA?"
    a: "Najczęściej stosuje się DCA miesięcznie - w synchronizacji z wypłatą. Ważniejsza od częstotliwości jest regularność i trzymanie się planu niezależnie od sytuacji rynkowej. Inwestuj w dołkach i na szczytach tak samo - to właśnie jest sedno strategii."
  - q: "Czy DCA działa w kryptowalutach?"
    a: "Tak, szczególnie dobrze - ze względu na bardzo wysoką zmienność kryptowalut, DCA skutecznie uśrednia cenę zakupu i chroni przed kupowaniem na szczytach. Historyczne dane dla Bitcoina pokazują, że regularne kupowanie BTC przez dowolny 4-letni okres dawało zysk."
---
...
Gdybyś w lutym (dołek) kupił jednorazowo za 2 000 zł przy cenie 80 zł - miałbyś 25 jednostek po 80 zł = świetnie. Ale gdybyś trafił w styczeń lub kwiecień, miałbyś mniej. [DCA automatycznie uśrednia twój koszt zakupu](/kalkulator/dca) - nie trafisz idealnie w dołek, ale też nie wejdziesz całą kwotą w szczyt.
