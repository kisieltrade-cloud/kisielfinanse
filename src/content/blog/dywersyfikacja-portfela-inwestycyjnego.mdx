---
title: "Jak naprawdę zdywersyfikować portfel inwestycyjny?"
metaTitle: "Jak zdywersyfikować portfel inwestycyjny?"
metaDescription: "Dywersyfikacja portfela inwestycyjnego - co to naprawdę znaczy? ETF na S&P 500 i MSCI World to nie dywersyfikacja. Jak zbudować odporny portfel."
...
readTime: 10 min
published: true
image: /images/blog/covers/mountain.jpg
keywords:
  ...
  - ryzyko inwestycyjne
faq:
  - q: "Co to jest dywersyfikacja portfela inwestycyjnego?"
    a: "Dywersyfikacja to rozłożenie kapitału między różne aktywa, które nie poruszają się w tym samym kierunku w tym samym czasie. Prawdziwa dywersyfikacja wymaga niskiej korelacji między aktywami - samo posiadanie wielu ETF-ów akcyjnych to nie dywersyfikacja, jeśli wszystkie są powiązane z rynkami akcji."
  - q: "Czy ETF na S&P 500 i MSCI World to dywersyfikacja?"
    a: "Nie w pełnym sensie. MSCI World zawiera ok. 70% akcji amerykańskich, więc portfel z S&P 500 + MSCI World to w praktyce podwójna ekspozycja na USA. Prawdziwa dywersyfikacja wymaga dodania aktywów o niskiej korelacji: obligacji, złota, rynków wschodzących, nieruchomości (REIT)."
  - q: "Ile klas aktywów potrzeba do dywersyfikacji?"
    a: "Klasyczny portfel 60/40 (akcje/obligacje) to minimum. Bardziej odporne portfele dodają złoto (5-10%), REIT-y i rynki wschodzące. Nie chodzi o liczbę aktywów, ale o ich wzajemną korelację - chcesz aktywów, które zachowują się różnie w różnych scenariuszach rynkowych."
  - q: "Co to jest rebalancing i jak często go robić?"
    a: "Rebalancing to przywracanie portfela do docelowych proporcji, gdy aktywa wzrosły lub spadły i zburzyły pierwotne wagi. Najczęściej robi się to raz w roku lub gdy dowolna klasa aktywów odchyli się o więcej niż 5-10% od celu. Za częsty rebalancing generuje koszty transakcyjne i podatki."
---
...
W praktyce [żadna para aktywów nie ma stałej korelacji](/trading/korelacje-miedzy-rynkami-w-tradingu) - zmienia się ona w czasie, a szczególnie rośnie podczas kryzysów, gdy inwestorzy wyprzedają wszystko jednocześnie.
...
---
![Strategia inwestycyjna](/images/blog/covers/chess-strategy.jpg)
...
Rozkładanie zakupów w czasie, zamiast inwestowania całości naraz, redukuje ryzyko wejścia w złym momencie. [Strategia DCA (Dollar-Cost Averaging)](/kalkulator/dca) - regularne wpłaty stałej kwoty niezależnie od poziomu rynku - nie maksymalizuje zwrotów, ale ogranicza psychologiczne ryzyko błędów wyczucia rynku.
...
---
![Złote monety w portfelu](/images/blog/covers/coins-gold.jpg)
