...
Oszczędności długoterminowe, odkładane z myślą o konkretnym celu w horyzoncie powyżej roku lub dwóch, mogą trafić do obligacji skarbowych lub lokat terminowych, gdzie oprocentowanie jest wyższe w zamian za ograniczoną płynność. Warto też porównać to z inwestycją w ETF — sprawdź [symulację ETF vs lokata](/kalkulator/etf) i zobacz, ile różnicy robi podatek Belki na przestrzeni lat.
