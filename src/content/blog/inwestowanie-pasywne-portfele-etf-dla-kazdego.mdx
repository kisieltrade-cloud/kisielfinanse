...
**Strategia:** kup co miesiąc tyle jednostek ile możesz, niezależnie od ceny. Nie sprzedawaj. Reinwestuj dywidendy (VWCE jest akumulacyjny - robi to automatycznie). Powtarzaj przez 15-30 lat.

**Dla kogo:** każdy, kto chce inwestować pasywnie nie myśląc o proporcjach. Szczególnie dobry na IKE w DM BOŚ gdzie możesz kupować VWCE na Xetrze.

**Wada:** 100% ekspozycja na akcje - w kryzysie może spaść 40-50% wartości. Wymaga żelaznych nerwów i długiego horyzontu.
...
**Rebalancing:** raz w roku sprawdź proporcje i przywróć do 80/20. Przy regularnych wpłatach możesz to robić automatycznie kupując więcej tego co "tańsze" w danym momencie.

**Dla kogo:** osoby z horyzontem 10-20 lat, które chcą ograniczyć zmienność portfela. Dobry dla kogoś, kto wie że mogą go przytłoczyć duże spadki.
...
**Spółki wartościowe (value):** historycznie spółki o niskim wskaźniku cena/wartość księgowa biją szeroki rynek w długim terminie (tzw. value premium). IUSV daje tę ekspozycję.

**Rynki wschodzące:** VWCE już zawiera emerging markets, ale nadważenie ich kosztem rynków rozwiniętych to zakład na szybszy wzrost Azji i Ameryki Łacińskiej w nadchodzących dekadach. Wiąże się z wyższym ryzykiem.

**Dla kogo:** inwestorzy z min. 5-7 lat doświadczenia, świadomi historii rynkowej i świadomi ryzyka. Nie dla kogoś, kto dopiero zaczyna.
...
Zaczynaj teraz. Kontynuuj zawsze. Reszta ułoży się sama.
