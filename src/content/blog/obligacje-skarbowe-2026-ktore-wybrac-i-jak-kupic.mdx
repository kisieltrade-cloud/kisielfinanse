...
metaDescription: "EDO 5,35%, COI 4,75%, TOS 4,40% - aktualne oprocentowanie obligacji skarbowych maj 2026. Kiedy wybrać obligacje zamiast lokaty i jak kupić przez internet."
keywords:
...
faq:
  - q: "Jakie jest oprocentowanie obligacji skarbowych w 2026 roku?"
    a: "W maju 2026 roku: TOS (3-letnie) 4,40% stałe przez cały okres, COI (4-letnie) 4,75% w pierwszym roku a od drugiego inflacja + marża 0,5%, EDO (10-letnie) 5,35% w pierwszym roku a od drugiego inflacja + marża 1,25%. Obligacje rodzinne ROD (12-letnie) oferują 5,60% w pierwszym roku."
...
Ważne: odsetki za każdy rok są naliczane i kapitalizowane na koniec każdego okresu, nie co miesiąc. Przy EDO odsetki dolicza się do kapitału raz w roku - czyli w roku 2 oprocentowanie naliczane jest od kapitału + odsetek z roku 1, co daje efekt procentu składanego.
...
Ważna uwaga techniczna: obligacje nie mają fizycznej formy. Są zapisywane na twoim rachunku w systemie Ministra Finansów. Nie potrzebujesz konta maklerskiego.
...
Obligacje skarbowe nie są dla każdego i do każdego celu. Oto kiedy mają sens a kiedy lepiej szukać gdzie indziej.

**Obligacje warto wybrać gdy:**
- Masz oszczędności, do których nie będziesz potrzebować dostępu przez rok lub dłużej
- Chcesz chronić wartość pieniędzy przed inflacją (COI, EDO)
- Zależy ci na bezpieczeństwie i pewności zwrotu
- Budujesz część portfela niezwiązaną z giełdą

**Obligacje nie mają sensu gdy:**
- Potrzebujesz płynności - fundusz awaryjny powinien być na koncie oszczędnościowym, nie w obligacjach
- Inwestujesz na emeryturę - w długim horyzoncie zdywersyfikowany portfel ETF-ów historycznie bija obligacje
- Chcesz maksymalizować zwrot - obligacje to bezpieczeństwo, nie wzrost
