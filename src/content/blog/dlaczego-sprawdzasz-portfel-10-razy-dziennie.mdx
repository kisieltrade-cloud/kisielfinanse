...
## Praktyczne narzędzia, które pomagają sprawdzać rzadziej

Kilka rzeczy, które faktycznie działają na zmniejszenie częstotliwości sprawdzania.

Wyłącz powiadomienia z aplikacji maklerskiej - pisałem o tym wyżej, ale warto powtórzyć. To najłatwiejsza zmiana o największym efekcie. Powiadomienie push o ruchu ceny to zaproszenie do sprawdzenia, a sprawdzenie to zaproszenie do działania.

Ustaw alerty cenowe zamiast ciągłego monitorowania. Większość platform maklerskich pozwala ustawić powiadomienie gdy cena przekroczy określony poziom - np. gdy akcja spadnie poniżej ceny, przy której zastanawiałeś się nad dokupieniem. To zamiast codziennego wchodzenia, żeby "tylko sprawdzić".

Prowadź dziennik inwestycyjny. Nie z wynikami, ale z decyzjami. Kiedy kupiłeś, po ile, dlaczego. Kiedy masz ochotę coś zrobić z portfelem, najpierw zapisujesz to w dzienniku - i widzisz, ile poprzednich "pilnych" decyzji okazało się zbędnych.

Regularne przeglądy zamiast ciągłego monitorowania. Zarezerwuj raz w miesiącu 30 minut na sprawdzenie portfela - z kalendarzem, nie impulsowo. Poza tym aplikacja maklerska jest zamknięta. To nie jest idealne rozwiązanie dla każdego, ale dla długoterminowego inwestora pasywnego - działa.
