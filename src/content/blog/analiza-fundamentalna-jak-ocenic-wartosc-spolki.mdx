...
metaTitle: "Jak ocenić wartość spółki? Analiza fundamentalna"
metaDescription: "Analiza fundamentalna dla inwestorów - jak ocenić wartość spółki, czytać wskaźniki i unikać pułapki C/Z. Krok po kroku bez skomplikowanych modeli."
...
faq:
  - q: "Co to jest analiza fundamentalna i czym różni się od technicznej?"
    a: "Analiza fundamentalna ocenia wartość wewnętrzną spółki przez badanie finansów, modelu biznesowego i pozycji rynkowej. Analiza techniczna analizuje wykresy i wolumen. Fundamentalna odpowiada na pytanie 'co kupić', techniczna - 'kiedy kupić'."
  - q: "Jakie wskaźniki analizować przy ocenie spółki?"
    a: "Kluczowe wskaźniki to: C/Z (cena do zysku), EV/EBITDA (wartość przedsiębiorstwa do zysku operacyjnego), ROE (zwrot z kapitału własnego), FCF (wolne przepływy pieniężne) i zadłużenie netto. Żaden wskaźnik nie działa w izolacji - zawsze porównuj ze średnią branżową."
  - q: "Czy niskie C/Z zawsze oznacza tanią spółkę?"
    a: "Nie. Niskie C/Z może oznaczać pułapkę wartości - spółka jest tania, bo rynek spodziewa się spadku zysków lub ma poważne problemy strukturalne. Zawsze sprawdzaj trend zysków, zadłużenie i jakość zarządzania obok samego C/Z."
  - q: "Jak samodzielnie wycenić wartość spółki?"
    a: "Najprostsza metoda to porównawcza - zestawiasz wskaźniki spółki ze średnią branżową i konkurencją. Bardziej zaawansowana to DCF (zdyskontowane przepływy pieniężne), gdzie projektujesz przyszłe FCF i dyskontujeszje do wartości bieżącej. Dla początkujących wystarczy metoda porównawcza."
---
