...
faq:
  - q: "Co daje największy zysk w 2026 - lokata, obligacje czy konto oszczędnościowe?"
    a: "Promocyjne lokaty krótkookresowe mogą dojść do 6-7%, ale obowiązują tylko przez 90 dni dla nowych środków. Na stałe: obligacje EDO 5,35% (rok 1), następnie inflacja + 2,00%, standardowe konto oszczędnościowe 3-3,5%. W długim terminie obligacje inflacyjne wygrywają ze standardowymi kontami."
...
- COI 4-letnie: 4,75% w roku 1, od roku 2 inflacja + 1,50%
- EDO 10-letnie: 5,35% w roku 1, od roku 2 inflacja + 2,00%

[COI i EDO mają oprocentowanie zmienne, powiązane z inflacją](/kalkulator/odsetki-obligacje). Realna stopa zwrotu jest zawsze dodatnia - zawsze zarabiasz powyżej inflacji o wartość marży. Żaden inny instrument detaliczny nie daje takiej gwarancji.
...
|---|---|---|---|
| Oprocentowanie | 3-3,5% (stałe) | do 6,7% (krótko) | 5,35% rok 1, potem inf.+2,00% |
...
Obligacje EDO przy inflacji 2,1% w roku 2: oprocentowanie 2,1% + 2,00% = 4,10%. Netto po Belce ok. 3,32%. Lepsze niż konto oszczędnościowe - ale skromnie. Przy wyższej inflacji przewaga obligacji rośnie.
...
**Oszczędności długoterminowe bez przypisanego celu:** obligacje EDO. Inflacja + 2,00% rocznie przez 10 lat to gwarancja, że za dekadę te pieniądze będą warte przynajmniej tyle samo co dziś. Do tego dochodzi efekt procentu składanego, bo odsetki doliczają się co roku do podstawy.
