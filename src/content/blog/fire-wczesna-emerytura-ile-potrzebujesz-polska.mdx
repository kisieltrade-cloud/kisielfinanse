...
**IKE:** inwestuj maksymalnie (limit 28 260 zł w 2026). Przy wypłacie po 60. roku życia - zero podatku Belki. Jeśli celujesz w FIRE przy 55-60 latach, IKE jest doskonałym narzędziem.

**IKZE:** natychmiastowa ulga podatkowa. Odliczasz od PIT, a oszczędzone pieniądze wpłacasz z powrotem. Przy 32% podatku i 20 latach = ponad 70 000 zł samych zwrotów podatkowych.

**Portfel ETF poza IKE/IKZE:** po wyczerpaniu limitów, standardowe konto maklerskie z globalnym ETF-em (VWCE). Podatek Belki od zysku jest kosztem, ale portfel i tak rośnie.

**Nieruchomość na wynajem:** część osób dochodzi do FIRE przez portfel nieruchomości zamiast portfela akcji. Wynajem generuje pasywny dochód podobny do dywidend. Wymaga innego kapitału startowego i aktywnego zarządzania.
