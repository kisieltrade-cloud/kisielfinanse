...
const READS = [
  ...
  { t: 'Średnie kroczące - SMA i EMA', s: 'Kierunek trendu i dynamiczne wsparcie', href: '/trading/srednie-kroczace-sma-ema-jak-uzywac' },
  { t: 'Price action', s: 'Trading na czystym wykresie, bez wskaźników', href: '/trading/price-action-trading-bez-wskaznikow' },
  { t: 'Formacja głowa i ramiona', s: 'Jak rozpoznać odwrócenie trendu', href: '/trading/formacja-glowa-i-ramiona' },
  { t: 'Wolumen w tradingu', s: 'Jak ocenić siłę ruchu ceny', href: '/trading/wolumen-w-tradingu-jak-czytac' },
  { t: 'Koszty tradingu', s: 'Spread, prowizja i swap bez tajemnic', href: '/trading/koszty-tradingu-spread-prowizje-swap' },
