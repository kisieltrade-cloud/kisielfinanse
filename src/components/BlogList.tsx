...
export default function BlogList({ posts }: Props) {
  ...
  return (
    <>
      {/* Tag filters + search w jednym rzędzie */}
      <div className="blog-filters">
        ...
        {/* Search — inline po prawej */}
        <div className="blog-search-wrap">
          <svg className="blog-search-icon" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          />
          {query && (
            <button className="blog-search-clear" onClick={() => setQuery('')} aria-label="Wyczyść">×</button>
          )}
        </div>
      </div>
