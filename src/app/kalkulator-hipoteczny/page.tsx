...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/kalkulator-hipoteczny/opengraph-image', width: 1200, height: 630, alt: 'Kalkulator Hipoteczny KisielFinanse' }],
  },
  twitter: {
    ...
    images: ['/kalkulator-hipoteczny/opengraph-image'],
  },
};
