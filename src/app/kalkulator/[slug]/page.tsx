...
const TABS: Record<string, {
  ...
  'procent-skladany': {
    ...
    metaTitle: 'Kalkulator Procentu Składanego - ile urośnie Twój kapitał? | KisielFinanse',
  ...
  'fire': {
    ...
    metaTitle: 'Kalkulator FIRE - kiedy osiągniesz wolność finansową? | KisielFinanse',
  ...
  'etf': {
    ...
    metaTitle: 'Kalkulator ETF vs lokata - co bardziej się opłaca? | KisielFinanse',
