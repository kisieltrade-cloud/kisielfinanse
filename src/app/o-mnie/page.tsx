    ...
    <>
      ...
      <main>
        ...
        <section style={{ position: 'relative', paddingTop: 80, borderBottom: '1px solid rgba(255,255,255,0.06)', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to right, rgba(3,5,8,0.95) 25%, rgba(3,5,8,0.7) 55%, rgba(3,5,8,0.25) 100%)', zIndex: 1 }} />
          ...
          <div className="omnie-hero" style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 2 }}>
            ...
            <div style={{ padding: 'clamp(48px, 6vw, 80px) clamp(24px, 5vw, 72px)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <p style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(0.88rem, 1.4vw, 1rem)', color: 'rgba(255,255,255,0.72)', lineHeight: 1.8, maxWidth: 460, margin: '0 0 14px' }}>
              ...
              <p style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(0.88rem, 1.4vw, 1rem)', color: 'rgba(255,255,255,0.72)', lineHeight: 1.8, maxWidth: 460, margin: '0 0 36px' }}>
              ...
              <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
                <a
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: 8, fontFamily: 'var(--font-mono)', fontSize: '0.68rem', letterSpacing: '1.5px', color: 'rgba(255,255,255,0.45)', textDecoration: 'none' }}
                >
            ...
            <div className="omnie-hero-photo" style={{ position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{
                ...
                background: 'linear-gradient(to right, rgba(3,5,8,0.8) 0%, transparent 40%)',
                zIndex: 1,
              }} />
              {/* Bottom fade */}
              <div style={{
                position: 'absolute', inset: 0,
                background: 'linear-gradient(to top, rgba(3,5,8,0.6) 0%, transparent 50%)',
                zIndex: 1,
              }} />
            </div>
